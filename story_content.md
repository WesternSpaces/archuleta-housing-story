# Housing in Archuleta County: Follow the Story

*An interactive guide to understanding our housing challenge*
...
- Maximum home price: Out of reach
...
Let's follow each household through the affordability calculation.

### How "Affordable" Is Defined

Housing is considered affordable when a household spends **no more than 30% of their gross income** on housing costs (rent or mortgage + taxes + insurance). This is the standard used by federal programs and housing policy nationwide.

When households spend more than 30%, they're considered **"cost-burdened"**—meaning less money for food, healthcare, transportation, and savings.
...
- **44-48% of Archuleta County households are cost-burdened**—spending more than 30% of income on housing
- **Rental vacancy rate: 0.5%**—a healthy market has 5-7%. Ours is essentially closed.
- **Median rent increased 57%** since 2012
- **Median home price increased 56%** since 2020

---

### Learn More: What Is AMI?

**Area Median Income (AMI)** is the middle point of all household incomes in our area—half of households earn more, half earn less. The U.S. Department of Housing and Urban Development (HUD) calculates AMI for every county each year.

**For Archuleta County in 2025 (2-person household):**
- 100% AMI = $81,600/year
- 80% AMI = $65,300/year (often called "low income" in housing programs)
- 50% AMI = $40,800/year (often called "very low income")
...
| Finding | Number |
|---------|--------|
| **Employers citing housing as their #1 hiring barrier** | 60% |
| **Employers citing cost of living as recruitment barrier** | 67% |
| **Positions unfilled at peak tourism season** | ~17% |
| **Workers commuting in from other communities** | 1,456 |

### The Jobs-Housing Imbalance

Pagosa Springs has **3.5 jobs for every working household**. This is one of the most extreme ratios in Colorado.
...
## Chapter 4: We're Not Starting From Scratch

Good news: our community has already taken steps to address housing. Let's look at what's happening—and how it connects to our four households.
...
About **1,100 housing units** are in various stages of planning and development:

| Project | Units | Affordability | Timeline |
|---------|-------|---------------|----------|
| Pagosa Views | 650 | 10% deed-restricted (60-140% AMI) | 2026 start, 7-15 year buildout |
| Timberline Apartments | 100 | LIHTC (30-80% AMI) | 2026-2030 |
| The Enclave | 70 | Deed-restricted (60-90% AMI) | 2027 start |
| Pagosa Peaks | 96 | 10% deed-restricted | 2027 start |
| Chris Mountain Phase 2 | 50 | Workforce housing | 2024-2031 |

**The good news:** If these projects move forward, they could meet much of the projected need.
...
Both the Town and County have established housing as a priority:

- **Archuleta County Strategic Plan (2025)** — "Address Affordable Cost of Living" is a strategic initiative
- **Town Vision 2050 (2025)** — Explicitly identifies housing affordability as a top community challenge
- **Short-term rental regulations** — Both jurisdictions require permits
- **ADU policies** — Accessory dwelling units permitted in both jurisdictions
- **Fee waivers** — Available for qualifying affordable projects
...
- [ ] Down payment assistance (HomesFund)
- [ ] Workforce housing developments (Chris Mountain, etc.)
- [ ] Senior housing options
- [ ] Fee waivers for affordable projects
- [ ] None of these / I didn't know about any
...
### The Housing Action Plan Process

This open house is one part of a larger effort. Here's where we are:

```
[✓] Housing Needs Assessment (Completed April 2025)
    └── Data on who needs what, how much, where
...
[ ] Draft Plan Review (Summer 2026)
    └── Strategy Group and public comment
...
**Tonight:** Visit the stations, share your input, ask questions

**After tonight:**
- Scan the QR code to explore this story and share with family
- Visit [mypagosa link] for the virtual open house
- Sign up for updates at the welcome table

**Coming up:**
- Open House #2 (Spring 2026) — Review draft strategies
- Public comment period on draft plan
- Town Council and County Commission adoption hearings

### Learn More

**Full Housing Needs Assessment:** [Link to HNA PDF]

**Questions?** Contact the Housing Coordinator or email sarah@westernspaces.co

---

## Thank You

Thank you for taking time to engage with this story. Your input matters.

Housing policy can feel overwhelming, but it comes down to a simple question: **Can the people who make our community work—healthcare workers, teachers, restaurant staff, seniors who've lived here for decades—afford to live here?**

Right now, for too many, the answer is no. The Housing Action Plan is our chance to change that.

**Your story is part of this story.** Thank you for sharing it.

---

*Prepared by Western Spaces for the Archuleta County & Town of Pagosa Springs Housing Action Plan*

*Data source: 2025 Regional Housing Needs Assessment by ECOnorthwest and Western Spaces*
